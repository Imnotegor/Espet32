...
const char index_html[] PROGMEM = R"rawliteral(<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no"><title>NeuroPet</title><style>
...
</style></head><body><div class="container"><header><h1 id="pet-name" onclick="showNameEdit()">NeuroPet</h1><div id="name-edit" class="name-edit"><input type="text" id="name-input" class="name-input" maxlength="24"><button onclick="saveName()" class="btn btn-primary" data-i18n="save">Save</button><button onclick="hideNameEdit()" class="btn btn-muted" data-i18n="cancel">Cancel</button></div><div class="status-bar"><span class="status-dot" id="ws-dot"></span><span id="ws-status" data-i18n="connecting">Connecting...</span></div></header><div class="pet-section"><canvas id="pet-canvas" width="280" height="200"></canvas><div class="action-label" id="action-label">...</div></div><div class="led-display"><div class="led-item"><div class="led-circle" id="led-hunger"></div><div class="led-label" data-i18n="hunger">Hunger</div></div><div class="led-item"><div class="led-circle" id="led-mood"></div><div class="led-label" data-i18n="mood">Mood</div></div></div><div class="stats-grid"><div class="stat-card"><div class="stat-label" data-i18n="hunger">Hunger</div><div class="stat-bar"><div class="stat-fill" id="hunger-bar"></div></div><div class="stat-val" id="hunger-val">0%</div></div><div class="stat-card"><div class="stat-label" data-i18n="energy">Energy</div><div class="stat-bar"><div class="stat-fill" id="energy-bar"></div></div><div class="stat-val" id="energy-val">0%</div></div><div class="stat-card"><div class="stat-label" data-i18n="affection">Affection</div><div class="stat-bar"><div class="stat-fill" id="affection-bar"></div></div><div class="stat-val" id="affection-val">0%</div></div><div class="stat-card"><div class="stat-label" data-i18n="trust">Trust</div><div class="stat-bar"><div class="stat-fill" id="trust-bar"></div></div><div class="stat-val" id="trust-val">0%</div></div></div><div class="time-section"><div class="time-label" data-i18n="petTime">Pet Time</div><div><span class="time-display" id="pet-time">--:--</span><span class="night-badge" id="night-badge" data-i18n="night">Night</span></div><div class="time-controls"><input type="time" id="time-input" class="time-input"><button onclick="setTime()" class="btn btn-primary" data-i18n="set">Set</button><button onclick="syncTime()" class="btn btn-secondary" data-i18n="sync">Sync</button></div></div></div><script>
const I18N = {
en: {
connecting: 'Connecting...',
connected: 'Connected',
